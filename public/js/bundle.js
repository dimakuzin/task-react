...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventsReducer = __webpack_require__(189);
	...
	var reducers = (0, _redux.combineReducers)({
	    eventsReducer: _eventsReducer2.default
	});
...
/***/ function(module, exports) {
	...
	var GET_DETAIL_EVENT_SUCCESS = exports.GET_DETAIL_EVENT_SUCCESS = 'GET_DETAIL_EVENT_SUCCESS';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventsListContainer = __webpack_require__(250);

	var _eventsListContainer2 = _interopRequireDefault(_eventsListContainer);

	var _datailEventContainer = __webpack_require__(271);

	var _datailEventContainer2 = _interopRequireDefault(_datailEventContainer);
	...
	exports.default = _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(
				_reactRouter.Route,
				{ path: '/' },
				_react2.default.createElement(_reactRouter.IndexRoute, { component: _eventsListContainer2.default }),
				_react2.default.createElement(_reactRouter.Route, { path: ':eventId', component: _datailEventContainer2.default })
			)
		)
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventsApi = __webpack_require__(252);

	var eventsApi = _interopRequireWildcard(_eventsApi);
	...
	var EventListContainer = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(_eventList2.default, { events: this.props.events });
		}
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(EventListContainer);
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'col-md-4' },
	                            'Author: ' + event.created_by.username
	                        ),
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'col-md-4' },
	                        ...
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'col-md-4' },
	                            'subscr: ' + event.subscribers_count
	                        )
	                    )
	                ),
	                _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventsActions = __webpack_require__(270);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function getEvents() {
		return _axios2.default.get('http://api.itboost.org:88/app_dev.php/api/community.getAll').then(function (response) {
			_store2.default.dispatch((0, _eventsActions.getEventsSuccess)(response.data.response.items));
			return response;
		});
	} /**
	...
	function getEvent(eventId) {
		return _axios2.default.get('http://api.itboost.org:88/app_dev.php/api/community.get?community_id=' + eventId).then(function (response) {
			_store2.default.dispatch((0, _eventsActions.getDetailEventSuccess)(response.data.response));
			return response;
		});
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getEventsSuccess = getEventsSuccess;
	exports.getDetailEventSuccess = getDetailEventSuccess;
	...
	function getDetailEventSuccess(event) {
		return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventDetail = __webpack_require__(272);
	...
	var EventDetailContainer = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(_eventDetail2.default, { event: this.props.event });
		}
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(EventDetailContainer);
	...
	exports.default = function (props) {
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'div',
				{ className: 'col-md-12' },
				props.event.community.name
			),
			_react2.default.createElement(
				'div',
				{ className: 'col-md-12' },
				props.event.community.description
			),
			_react2.default.createElement(
				'div',
				{ className: 'col-md-12' },
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'col-md-4' },
						'total members: ' + props.event.members.total_count
					)
				),
				props.event.members.items.map(function (item) {
					return _react2.default.createElement(
						'div',
